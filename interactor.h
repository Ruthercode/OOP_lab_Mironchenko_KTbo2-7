...
private:
    ...
    Matrix* _second;
public:
    Interactor(): _first(nullptr), _second(nullptr) {}

    void readOblects(std::string file)
    {
    ...
    std::string interaction(char command, int target, int cnt)
    {
    ...
    friend std::ostream& operator<<(std::ostream& out, const Interactor& object)
    {
        out << "///////////////////////////////////\n";
